# 🥕 Projeto Teste Hortifruit

Este projeto foi desenvolvido para fins de teste e aprendizado.  
...
### HTTPS
```bash
git clone https://github.com/martinscjhon/projeto_teste_hortifruit.git
```
